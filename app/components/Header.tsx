...
export function Header() {
  ...
  const h = dark ? {
    ...
    allCats: 'bg-[#121f33] hover:bg-[#1a2d49] text-white border border-white/10',
    navCat: 'text-gray-300 hover:text-white hover:bg-[#16263d] border border-white/10',
    ...
    allCats: 'bg-white hover:bg-gray-50 text-gray-900 border border-gray-200',
    navCat: 'text-gray-900 hover:text-gray-900 hover:bg-gray-50 border border-gray-200',
